...
HOST = '10.60.15.17'    # Server(Raspberry Pi) IP address
PORT = 21567
...
def left_reverse(event):
	left_cmd = 'leftreverse'.encode()
	tcpCliSock.send(left_cmd)

def right_reverse(event):
	right_cmd = 'rightreverse'.encode()
